...
class DepthTagTestCase(unittest.TestCase):
    ...
    def test_metaheader(self):
        self.assertEqual('##FORMAT=<ID={0}MT,Number=1,Type=Float,Description="Jacquard depth for MuTect (based on DP),Source="Jacquard",Version={1}>\n'.format(jq_dp_tag, __version__), mutect._DepthTag().metaheader)
