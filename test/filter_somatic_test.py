...
class FilterSomaticTestCase(unittest.TestCase):
    ...
    def test_writeSomatic(self):
        ...
        self.assertEqual("##jacquard.filterSomatic.excluded_variants=5\n", excluded_variants)
    ...
    def test_writeSomatic(self):
        ...
        self.assertEqual("##jacquard.filterSomatic.excluded_variants=14\n", excluded_variants)
        shutil.rmtree(output_dir)
